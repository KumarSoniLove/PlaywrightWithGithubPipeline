...
test('Create POST API request using static file in playwright & typescript', {tag: ['@PlaywrightWithAzureDevOpsPipeline','@PlaywrightWithGitHubActions']}, async ({request}) => {
